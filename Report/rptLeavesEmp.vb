...
Public Class rptLeavesEmp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BostanSecurity.rptLeavesEmp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLeavesEmp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLeavesEmp = New rptLeavesEmp()
        rpt.Site = Me.Site
        Return rpt
    End Function
