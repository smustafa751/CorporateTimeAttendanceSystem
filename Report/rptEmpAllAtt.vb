...
Public Class rptEmpAllAtt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BostanSecurity.rptEmpAllAtt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEmpAllAtt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEmpAllAtt = New rptEmpAllAtt()
        rpt.Site = Me.Site
        Return rpt
    End Function
