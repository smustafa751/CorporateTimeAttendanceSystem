...
Public Class rptLeavesEMP1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BostanSecurity.rptLeavesEMP1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Ed1() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Ed2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptLeavesEMP1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLeavesEMP1 = New rptLeavesEMP1()
        rpt.Site = Me.Site
        Return rpt
    End Function
