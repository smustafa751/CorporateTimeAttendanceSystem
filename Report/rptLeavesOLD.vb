...
Public Class rptLeavesOLD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BostanSecurity.rptLeavesOLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLeavesOLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLeavesOLD = New rptLeavesOLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
