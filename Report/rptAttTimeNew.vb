...
Public Class rptAttTimeNew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BostanSecurity.rptAttTimeNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAttTimeNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAttTimeNew = New rptAttTimeNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
